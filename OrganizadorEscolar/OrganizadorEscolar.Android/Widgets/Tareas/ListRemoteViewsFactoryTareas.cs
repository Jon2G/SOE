...
namespace OrganizadorEscolar.Droid.Widgets.Tareas
{
    ...
    /// </summary>
    public class ListRemoteViewsFactoryTareas : Java.Lang.Object, IRemoteViewsFactory
    {
        ...
        public int Count
        {
            get
            {
                ...
                return OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance.Tareas.Count;
            }
        }
        /// <summary>
        ...
        public ListRemoteViewsFactoryTareas(Context context, Intent intent)
        {
        ...
        {
            OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance?.Tareas.Clear();
        }
        /// <summary>
        ...
        public RemoteViews GetViewAt(int position)
        {
            ...
            RemoteViews rv = new RemoteViews(mContext.PackageName, Resource.Layout.widget_item_tareas);
            rv.SetTextViewText(Resource.Id.widget_item_tareas_descripcion, OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance.Tareas[position].Descripcion);
            rv.SetTextViewText(Resource.Id.widget_item_tareas_materia, OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance.Tareas[position].NombreMateria);
            rv.SetTextViewText(Resource.Id.widget_item_tareas_emoji, OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance.Tareas[position].Emoji);

            Color color = Color.ParseColor(OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance.Tareas[position].Color);
            rv.SetInt(Resource.Id.widget_item_tareas, "setBackgroundColor", color);

            // Next, we set a fill-intent which will be used to fill-in the pending intent template
            // which is set on the collection view in ListWidgetProvider.
            Bundle extras = new Bundle();
            extras.PutInt(AppWidgetTareas.EXTRA_ITEM, position);
            extras.PutString(AppWidgetTareas.EXTRA_LABEL, OrganizadorEscolar.Widgets.Tareas.WidgetTareas.Instance.Tareas[position].Descripcion);

            Intent fillInIntent = new Intent();
            fillInIntent.PutExtras(extras);
            // Make it possible to distinguish the individual on-click
            // action of a given item
            rv.SetOnClickFillInIntent(Resource.Id.widget_item_tareas, fillInIntent);
