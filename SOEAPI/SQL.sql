...
SELECT @TEACHER_SUBJECTS_ID=ID FROM TEACHER_SUBJECTS WHERE TEACHER_ID=@TEACHER_ID AND SUBJECT_ID=@SUBJECT_ID
IF @TEACHER_SUBJECTS_ID<=0 
BEGIN
...
WHERE USER_ID=@USER_ID AND TEACHER_SUBJECTS_ID=@TEACHER_SUBJECTS_ID AND GROUP_ID=@GROUP_ID
