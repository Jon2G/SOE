...
GO
INSERT INTO USERS
VALUES(newid(),17,2,'Jonathan García','2021130425','jonathan.edu.gar@gmail.com','12345678',0,0,0);
GO 
...
where (MAIL=@MAIL OR BOLETA=@MAIL);
...
BEGIN 
	select @USER_ID=ID From USERS
	where ID=@USER_ID AND PASSWORD_PIN=@PASSWORD_PIN;
