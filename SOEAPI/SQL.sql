...
IF NOT EXISTS(SELECT ID FROM USERS_SCHOOLS WHERE USER_ID=@USER_ID AND SCHOOL_ID=@SCHOOL_ID)
	...
	BEGIN
		...
		BEGIN
			...
			SELECT 'OK','Bienvenido','{"Boleta":"'+BOLETA+'","School":"'+@SCHOOL+'","Id":"'+@USER_ID+'"}'
...
select 
	...
	SUBJECT_COMMENTS.ID,SUBJECT_ID,PARENT_COMMENT_ID,TEXT,USERS.GUID AS 'USER_GUID',USERS.NICK_NAME,HAS_SUBCOMMENTS,DATE,TIME,VOTES
...
SELECT LINKS.NAME,LINKS.URL,LINKS.ID
FROM INSCRIPTIONS
