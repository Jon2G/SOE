...
IF NOT EXISTS(SELECT ID FROM USERS_SCHOOLS WHERE USER_ID=@USER_ID AND SCHOOL_ID=@SCHOOL_ID)
	...
	BEGIN
		...
		BEGIN
			...
			SELECT @SCHOOL='{"Id":"'+CAST(@SCHOOL_ID AS varchar(MAX))+'","HomePage":"'+HOME_PAGE+'","Name":"'+NAME+'","ImgPath":"'+IMG_PATH+'"}'
...
END
GO
CREATE PROCEDURE SP_IsNickNameAvaible(@NICK_NAME VARCHAR(50))
AS
BEGIN
